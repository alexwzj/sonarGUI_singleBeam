...
sys.path.append(str(Path(__file__).parent.parent.parent))  # add YoLoV5/ to path
from YoLoV5.datasets import LoadImagesAndLabels
from YoLoV5.datasets import img2label_paths
from YoLoV5.general import colorstr, check_dataset, check_file
