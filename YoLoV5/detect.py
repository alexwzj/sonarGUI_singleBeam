...
from YoLoV5.datasets import LoadStreams, LoadImages
from YoLoV5.general import check_img_size, check_requirements, check_imshow, colorstr, non_max_suppression, \
    apply_classifier, scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path, save_one_box
from YoLoV5.plots import colors, plot_one_box
from YoLoV5.torch_utils import select_device, load_classifier, time_sync
...
def run(weights='yolov5s.pt',  # model.pt path(s)   权重文件地址 默认 weights/可以是自己的路径
        ...
        project='runs/detect',  # save results to project/name    保存测试日志的文件夹路径
        ...
        half=False,  # use FP16 half-precision inference    是否使用F16精度推理, 半精度提高检测速度
        ):
    # 是否保存图片和txt文件
